...
class GeoNodeNoseTestRunner(NoseTestSuiteRunner):
    """ This test runner allows the exclusion of some
        of the apps from the test suite and uses NoseTestSuitRunner
        as it's base class instead of the built-in Django one.
    """
    EXCLUDED_APPS = [
        # Registration complains about email
        # messages in spanish, ticket has been filled at:
